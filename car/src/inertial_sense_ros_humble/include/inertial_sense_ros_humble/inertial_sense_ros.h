...
class InertialSenseROS : public rclcpp::Node //: SerialListener
{
  public:
    ...
    // bool set_refLLA_to_value(inertial_sense_ros::refLLAUpdate::Request &req,
    // inertial_sense_ros::refLLAUpdate::Response &res); bool perform_mag_cal_srv_callback(std_srvs::Trigger::Request &
    // req, std_srvs::Trigger::Response & res); bool perform_multi_mag_cal_srv_callback(std_srvs::Trigger::Request &
    // req, std_srvs::Trigger::Response & res); bool
    // update_firmware_srv_callback(inertial_sense_ros::FirmwareUpdate::Request & req,
