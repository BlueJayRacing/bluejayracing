...
private:
    ...
    void translate_communication(const baja_msgs::msg::Communication& ros_communication, Communication& proto_communication);
    void translate_analog_channel(const baja_msgs::msg::AnalogChannel& ros_analog_channel, AnalogChannel& proto_analog_channel);
    void translate_car_state(const baja_msgs::msg::CarState& ros_car_state, CarState& proto_car_state);
    void translate_rtk_correction(const baja_msgs::msg::RTKCorrection& ros_rtk_correction, RTKCorrection& proto_rtk_correction);
