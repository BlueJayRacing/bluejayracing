...
def generate_launch_description():
    ...
    imx_pkg_path = get_package_share_directory('rpi_launch')
    imx_nodes_launch_path = os.path.join(imx_pkg_path, 'launch', 'imx_param.launch')
    imx_nodes_launch = IncludeLaunchDescription(
	XMLLaunchDescriptionSource([imx_nodes_launch_path])
    )
