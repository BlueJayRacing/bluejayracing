...
void xbee_reset_pin(xbee_dev_t* xbee, int enable) { _zb_reset(enable); }
int xbee_awake_pin(xbee_dev_t* xbee) { return BitRdPortI(PDDR, 3); }
...
int xbee_awake_pin(xbee_dev_t* xbee) { return BitRdPortI(PDDR, 2); }
