...
static int receive_handler(xbee_dev_t* xbee, const void FAR* frame, uint16_t length, void FAR* context);
static int tx_status_handler(xbee_dev_t* xbee, const void FAR* frame, uint16_t length, void FAR* context);
...
static int receive_handler(xbee_dev_t* xbee, const void FAR* frame_in, uint16_t frame_len, void FAR* context)
{
...
static int tx_status_handler(xbee_dev_t* xbee, const void FAR* frame_in, uint16_t frame_len, void FAR* context)
{
