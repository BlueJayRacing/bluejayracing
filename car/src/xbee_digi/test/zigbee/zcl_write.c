...
const uint8_t payload_bigwrongtype[] = {
    ...
    _LE16(TEST_ATTRIBUTE + 1), ZCL_TYPE_UNSIGNED_8BIT, 0xFF,
...
const uint8_t write_success[] = {ZCL_FRAME_TYPE_PROFILE | ZCL_FRAME_SERVER_TO_CLIENT | ZCL_FRAME_DISABLE_DEF_RESP,
                                 TEST_SEQUENCE, ZCL_CMD_WRITE_ATTRIB_RESP, ZCL_STATUS_SUCCESS};
...
{
    reset_common(payload_bigwrongtype, sizeof payload_bigwrongtype, response_bigwrongtype,
                 sizeof response_bigwrongtype);
    memcpy(write_error, write_error_master, sizeof write_error_master);
...
uint8_t mfg_write_error[] = {
    ZCL_FRAME_TYPE_PROFILE | ZCL_FRAME_SERVER_TO_CLIENT | ZCL_FRAME_DISABLE_DEF_RESP | ZCL_FRAME_MFG_SPECIFIC,
    _LE16(MFGID),
    TEST_SEQUENCE,
    ZCL_CMD_WRITE_ATTRIB_RESP,
