...
const uint8_t zcl_type_info[256] = {
    ...
    // 0x60 - 0x6F
    ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID,
    ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID, ZCL_T_INVALID,
    ZCL_T_INVALID, ZCL_T_INVALID,
...
#define _IN_RANGE_ASSIGN_PREFIX(group, low, high)                                                                      \
    (ZCL_TYPE_##group##_##low##BIT <= type && type <= ZCL_TYPE_##group##_##high##BIT) prefix = #group
