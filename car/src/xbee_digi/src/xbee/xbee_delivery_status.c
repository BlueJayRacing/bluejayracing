...
const char* xbee_tx_delivery_str(uint8_t status, char buffer[XBEE_TX_DELIVERY_STR_BUF_SIZE])
{
    ...
    case XBEE_TX_DELIVERY_CCA_FAIL:
        return "CCA failure";
    case XBEE_TX_DELIVERY_STACK_NOT_READY:
        return "stack not ready";
    case XBEE_TX_DELIVERY_PHYSICAL_ERROR:
    ...
    case XBEE_TX_DELIVERY_INTERNAL_ERROR:
        return "internal error";
    case XBEE_TX_DELIVERY_RESOURCE_ERROR:
        return "resource error";
    case XBEE_TX_DELIVERY_NO_SECURE_SESSION:
        return "no secure session";
    case XBEE_TX_DELIVERY_ENCRYPTION_FAILURE:
        return "encryption failure";
    case XBEE_TX_DELIVERY_PAYLOAD_TOO_BIG:
        return "payload too large";
    case XBEE_TX_DELIVERY_UNREQ_INDIRECT_MSG:
        return "unrequested indirect msg";
    case XBEE_TX_DELIVERY_SOCKET_CREATION_FAIL:
        return "socket creation failed";
    case XBEE_TX_DELIVERY_CONNECTION_DNE:
        return "connection doesn't exist";
    case XBEE_TX_DELIVERY_INVALID_UDP_PORT:
        return "invalid UDP port";
    case XBEE_TX_DELIVERY_INVALID_TCP_PORT:
        return "invalid TCP port";
    case XBEE_TX_DELIVERY_INVALID_HOST_ADDR:
        return "invalid host address";
    case XBEE_TX_DELIVERY_INVALID_DATA_MODE:
    ...
    case XBEE_TX_DELIVERY_CONNECTION_LOST:
        return "connection lost";
    case XBEE_TX_DELIVERY_NO_SERVER:
        return "no server";
    case XBEE_TX_DELIVERY_SOCKET_CLOSED:
        return "socket closed";
    case XBEE_TX_DELIVERY_UNKNOWN_SERVER:
        return "unknown server";
    case XBEE_TX_DELIVERY_UNKNOWN_ERROR:
        return "unknown error";
    case XBEE_TX_DELIVERY_INVALID_TLS_CONFIG:
