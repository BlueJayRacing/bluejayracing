...
#define XBEE_FRAME_DUMP_SS_RESP {XBEE_FRAME_SECURE_SESSION_RESP, 0, xbee_frame_dump_secure_session_resp, NULL}

/// Identify whether an extended modem status code is Secure Session related.
#define XBEE_MODEM_STATUS_IS_SS(code)                                                                                  \
    (code >= XBEE_MODEM_STATUS_SS_ESTABLISHED && code <= XBEE_MODEM_STATUS_SS_AUTH_FAILED)
