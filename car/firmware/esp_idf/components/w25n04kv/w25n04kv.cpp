...
esp_err_t W25N04KV::writePage(const std::vector<uint8_t>& tx_data, uint32_t page_address)
{
    ...
    std::vector<uint8_t> vec_page_address(3);
    vec_page_address[0] = (page_address & 0x00FF0000) >> 16;
    vec_page_address[1] = (page_address & 0x0000FF00) >> 8;
    vec_page_address[2] = (page_address & 0x000000FF) >> 0;
...
/*******************************************************************************
 * @brief Checks if a W25N04KV can be find given the initialization parameters.
 *******************************************************************************/
