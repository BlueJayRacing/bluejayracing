...
esp_err_t wifi_start(void)
{
    ...
    ESP_LOGI(TAG, "Set WiFi Protocol\n");
    ...
    ESP_LOGI(TAG, "default power: %d", power);
...
esp_err_t wifi_stop(void) { return esp_wifi_stop(); }

esp_err_t wifi_restart(void) { return esp_wifi_start(); }

bool wifi_is_connected(void) { return is_wifi_connected; }