...
int main(/*int argc, char* argv[]*/)
{
    ...
    for (int i = 0; i < 100000; i++) {
        ...
        // ", "; cout << static_cast<int16_t>(static_cast<uint16_t>(buf[3]) << 8 |
        // static_cast<uint16_t>(buf[2]))*.000061 << ", "; cout << static_cast<int16_t>(static_cast<uint16_t>(buf[5]) <<
        // 8 | static_cast<uint16_t>(buf[4]))*.000061 << endl;
