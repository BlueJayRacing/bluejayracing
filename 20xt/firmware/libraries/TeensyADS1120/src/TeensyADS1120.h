#ifndef TEENSY_ADS1120_h
#define TEENSY_ADS1120_h
...
class TeensyADS1120 : public SensorInterface {
  public:
    TeensyADS1120();
    ...
    void begin(uint8_t clk_pin, uint8_t miso_pin, uint8_t mosi_pin, uint8_t cs_pin, uint8_t drdy_pin, int spi_num);
