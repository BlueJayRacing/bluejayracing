...
int main() {
  ...
  vector<string> filenames = {"gps.csv", "localization.csv", "communication.csv", "analog_ch.csv", "car_state.csv",
                      "rtk_correction.csv"};
...
void log_communication(ofstream& f, Observation& observation) {
  ...
  if(com.has_instruction()){
    switch(com.instruction()){
      case Communication::STOP_IMMEDIATELY: instruction = "STOP_IMMEDIATELY"; break;
      case Communication::STOP_FOR_PIT: instruction = "STOP_FOR_PIT"; break;
      default: instruction = "";
    }
  }
  if(com.has_driver_response()){
    switch(com.driver_response()){
      case Communication::SEND_HELP: driver_response = "SEND_HELP"; break;
      case Communication::PIT_REQUEST: driver_response = "PIT_REQUEST"; break;
      default: driver_response = "";
    }
  }
...
void log_analog_ch(ofstream& f, Observation& observation) {
  ...
  switch(ana.channel_type()){
    case AnalogChannel::AXLE_TORQUE_FRONT_LEFT: channel_type = "AXLE_TORQUE_FRONT_LEFT"; break;
    case AnalogChannel::AXLE_TORQUE_FRONT_RIGHT: channel_type = "AXLE_TORQUE_FRONT_RIGHT"; break;
    case AnalogChannel::AXLE_TORQUE_REAR_LEFT: channel_type = "AXLE_TORQUE_REAR_LEFT"; break;
    case AnalogChannel::AXLE_TORQUE_REAR_RIGHT: channel_type = "AXLE_TORQUE_REAR_RIGHT"; break;

    case AnalogChannel::AXLE_RPM_FRONT_RIGHT: channel_type = "AXLE_RPM_FRONT_RIGHT"; break;
    case AnalogChannel::AXLE_RPM_FRONT_LEFT: channel_type = "AXLE_RPM_FRONT_LEFT"; break;
    case AnalogChannel::AXLE_RPM_REAR: channel_type = "AXLE_RPM_REAR"; break;

    case AnalogChannel::SHOCK_LEN_FRONT_RIGHT: channel_type = "SHOCK_LEN_FRONT_RIGHT"; break;
    case AnalogChannel::SHOCK_LEN_FRONT_LEFT: channel_type = "SHOCK_LEN_FRONT_LEFT"; break;
    case AnalogChannel::SHOCK_LEN_REAR_RIGHT: channel_type = "SHOCK_LEN_REAR_RIGHT"; break;
    case AnalogChannel::SHOCK_LEN_REAR_LEFT: channel_type = "SHOCK_LEN_REAR_LEFT"; break;
 
    case AnalogChannel::STEERING_DATA: channel_type = "STEERING_DATA"; break;
    case AnalogChannel::TACHOMETER: channel_type = "TACHOMETER"; break;
    case AnalogChannel::POWER_USE: channel_type = "POWER_USE"; break;
...
void log_car_state(ofstream& f, Observation& observation) {
  ...
  if(cs.has_engine_status()){
    switch(cs.engine_status()){
      case CarState::ENGINE_NORMAL: engine_status = "ENGINE_NORMAL"; break;
      case CarState::ENGINE_IDLING: engine_status = "ENGINE_IDLING"; break;
      case CarState::ENGINE_CHOKED: engine_status = "ENGINE_CHOKED"; break;
      case CarState::ENGINE_UNDERPERFORMING: engine_status = "ENGINE_UNDERPERFORMING"; break;
      case CarState::ENGINE_OFF: engine_status = "ENGINE_OFF"; break;
    }
  }
