...
int main()
{
    ...
    AnalogChannel_ChannelType channels[2][5] = {
        {AnalogChannel::SHOCK_LEN_FRONT_RIGHT, AnalogChannel::SHOCK_LEN_REAR_RIGHT, AnalogChannel::BRAKE_PRESSURE_FRONT,
         AnalogChannel::AXLE_RPM_REAR, AnalogChannel::AXLE_RPM_FRONT_RIGHT

        },
        {AnalogChannel::SHOCK_LEN_FRONT_LEFT, AnalogChannel::SHOCK_LEN_REAR_LEFT, AnalogChannel::BRAKE_PRESSURE_REAR,
         AnalogChannel::TACHOMETER, AnalogChannel::AXLE_RPM_FRONT_LEFT
