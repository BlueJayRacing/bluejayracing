...
typedef struct sxa_node_t {
    struct sxa_node_t FAR* next;       ///< Next in linked list (or NULL)
    struct sxa_node_t FAR* next_local; ///< Next in linked list of local
                                       ///< devices (or NULL)
...
#define XBEE_DISC_CLIENT_CLUST_ENTRY                                                                                   \
    {                                                                                                                  \
        DIGI_CLUST_NODEID_MESSAGE, _sxa_disc_cluster_handler, NULL, WPAN_CLUST_FLAG_INPUT | WPAN_CLUST_FLAG_NOT_ZCL    \
    }
...
#define XBEE_IO_CLIENT_CLUST_ENTRY                                                                                     \
    {                                                                                                                  \
        DIGI_CLUST_IODATA, _sxa_io_cluster_handler, NULL, WPAN_CLUST_FLAG_INPUT | WPAN_CLUST_FLAG_NOT_ZCL              \
    }
