...
*/
#define XBEE_ROUTE_DUMP_RECORD_INDICATOR {XBEE_FRAME_ROUTE_RECORD_INDICATOR, 0, xbee_route_dump_record_indicator, NULL}
...
/**
   ...
   indicators dumped to STDOUT.
*/
#define XBEE_ROUTE_DUMP_MANY_TO_ONE_REQ {XBEE_FRAME_ROUTE_MANY_TO_ONE_REQ, 0, xbee_route_dump_many_to_one_req, NULL}
