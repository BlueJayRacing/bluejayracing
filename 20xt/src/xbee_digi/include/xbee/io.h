...
typedef struct xbee_io_t {
    xbee_command_list_context_t clc; ///< Command list context used for
...
int xbee_io_set_digital_output(xbee_dev_t* xbee, xbee_io_t FAR* io, uint_fast8_t index,
                               enum xbee_io_digital_output_state state, const wpan_address_t FAR* address);
int xbee_io_configure(xbee_dev_t* xbee, xbee_io_t FAR* io, uint_fast8_t index, enum xbee_io_type type,
                      const wpan_address_t FAR* address);
int xbee_io_set_options(xbee_dev_t* xbee, xbee_io_t FAR* io, uint16_t sample_rate, uint16_t change_mask,
                        const wpan_address_t FAR* address);
