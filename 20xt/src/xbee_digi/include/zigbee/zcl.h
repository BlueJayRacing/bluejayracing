...
#define ZCL_CMD_MATCH(p, mfg, dir, type)                                                                               \
    ((*(const uint8_t FAR*)(p) & (ZCL_FRAME_MFG_SPECIFIC | ZCL_FRAME_DIRECTION | ZCL_FRAME_TYPE_MASK)) ==              \
...
#define ZCL_CMD_IS_CLUSTER(p)                                                                                          \
    (ZCL_FRAME_TYPE_CLUSTER == (*(const uint8_t FAR*)(p) & (ZCL_FRAME_TYPE_MASK | ZCL_FRAME_MFG_SPECIFIC)))
