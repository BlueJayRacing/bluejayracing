...
#define MULADDC_CORE                                                                                                   \
    __asm lodsd __asm mul ebx __asm add eax, ecx __asm adc edx, 0 __asm add eax, [edi] __asm adc edx, 0 __asm mov ecx, \
        edx __asm stosd
...
#define MULADDC_STOP EMIT 0x0F EMIT 0x77 __asm mov c, ecx __asm mov d, edi __asm mov s, esi

#else

#define MULADDC_STOP __asm mov c, ecx __asm mov d, edi __asm mov s, esi
