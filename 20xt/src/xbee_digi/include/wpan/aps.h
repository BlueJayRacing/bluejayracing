...
*/
typedef const wpan_endpoint_table_entry_t* (*wpan_endpoint_get_next_fn)(struct wpan_dev_t* dev,
...
/// of the table.
#define WPAN_ENDPOINT_TABLE_END                                                                                        \
    {                                                                                                                  \
...
const wpan_cluster_table_entry_t* wpan_cluster_match(uint16_t match, uint8_t mask,
...
const wpan_endpoint_table_entry_t* wpan_endpoint_of_cluster(wpan_dev_t* dev, uint16_t profile_id, uint16_t cluster_id,
                                                            uint8_t mask);
...
int wpan_conversation_register(wpan_ep_state_t FAR* state, wpan_response_fn handler, const void FAR* context,
                               uint16_t timeout);
