...
const char* xbee_sock_status_str(uint8_t status, char buffer[XBEE_SOCK_STR_BUF_SIZE])
{
    ...
    case XBEE_SOCK_STATUS_FAILED_TO_READ:
        return "failed to retrieve option";
    case XBEE_SOCK_STATUS_IN_PROGRESS:
        return "connect already in progress";
    case XBEE_SOCK_STATUS_CONNECTED:
        return "connected/bound/listening";
    case XBEE_SOCK_STATUS_UNKNOWN:
        return "unknown error";
    case XBEE_SOCK_STATUS_BAD_SOCKET:
        return "invalid socket ID";
    case XBEE_SOCK_STATUS_OFFLINE:
        return "not registered to network";
    case XBEE_SOCK_STATUS_INTERNAL_ERR:
        return "internal error";
    case XBEE_SOCK_STATUS_RESOURCE_ERR:
        return "resource error, try later";
    case XBEE_SOCK_STATUS_BAD_PROTOCOL:
...
const char* xbee_sock_state_str(uint8_t state, char buffer[XBEE_SOCK_STR_BUF_SIZE])
{
    ...
    case XBEE_SOCK_STATE_CONNECTED:
        return "connected";
    case XBEE_SOCK_STATE_DNS_FAILED:
        return "DNS failed";
    case XBEE_SOCK_STATE_CONNECTION_REFUSED:
        return "connection refused";
    case XBEE_SOCK_STATE_TRANSPORT_CLOSED:
        return "transport closed";
    case XBEE_SOCK_STATE_TIMED_OUT:
        return "timed out";
    case XBEE_SOCK_STATE_INTERNAL_ERR:
        return "internal error";
    case XBEE_SOCK_STATE_HOST_UNREACHABLE:
        return "host unreachable";
    case XBEE_SOCK_STATE_CONNECTION_LOST:
        return "connection lost";
    case XBEE_SOCK_STATE_UNKNOWN_ERR:
        return "unknown error";
    case XBEE_SOCK_STATE_UNKNOWN_SERVER:
        return "unknown server";
    case XBEE_SOCK_STATE_RESOURCE_ERR:
        return "resource error";
    case XBEE_SOCK_STATE_LISTENER_CLOSED:
